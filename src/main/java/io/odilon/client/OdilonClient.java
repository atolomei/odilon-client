...
public interface OdilonClient {
	...
	* </pre>
	 ...
	 * @param bucketName                  can not be null
	 * @param objectName                  can not be null
	 * @param urlExpiresInSeconds         duration in seconds for the url to be
	 *                                    valid
	 * @param objectCacheExpiresInSeconds The HTTP header cache duration in seconds
	 *                                    for the binary object served by this
	 *                                    token. This tells the web browser
	 *                                    downloading this object the maximum amount
	 *                                    of time it can cache it before
	 *                                    invalidating it.
	 * 
	 * @return temporary url to download the file without authentication
	 * 
	 */
	public String getPresignedObjectUrl(String bucketName, String objectName, Optional<Integer> urlExpiresInSeconds, Optional<Integer> objectCacheExpiresInSeconds) throws ODClientException;
